def swap(alist, index):
    ...
    alist[index] = b # sets 'b' into indexth item
    alist[index+1] = a # sets 'a' into the item after the indexth item
...
def bsort(alist): #sets varible 
    ...
    while swaps: # while swaps is true
        ...
        for i in range(len(alist)-1): # for every in alist apart from last number   
